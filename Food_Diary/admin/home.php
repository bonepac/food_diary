			...
			?>
				...
				<li style="margin-right:0px;">
					...
					<div class="property_details">
						...
						<h2>:<span class="property_size"><a href="#edit<?php echo $row['diet_id']; ?>" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span> Edit/Details</a> || 
							<a href="#del<?php echo $row['diet_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a></span>
							</span>
							</h2>
					</div>
				</li>
